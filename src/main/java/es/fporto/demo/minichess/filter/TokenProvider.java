...
import static es.fporto.demo.minichess.user.model.Constants.ACCESS_TOKEN_VALIDITY_SECONDS;
import static es.fporto.demo.minichess.user.model.Constants.AUTHORITIES_KEY;
import static es.fporto.demo.minichess.user.model.Constants.SIGNING_KEY;
